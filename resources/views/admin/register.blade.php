...
<head>
    <title>Đăng ký quản trị | Website quản trị v2.0</title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="{{asset('admin/')}}https://cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.min.css">
    ...
    <div class="container-login100">
        <div class="wrap-login100">
            <div class="login100-pic js-tilt" data-tilt>
                <img src="{{asset('admin/images/team.jpg')}}" alt="IMG">
            </div>
            <!--=====TIÊU ĐỀ======-->
            <form class="login100-form validate-form" method="POST">
                ...
                <!--=====FORM INPUT TÀI KHOẢN VÀ PASSWORD======-->
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" placeholder="Tên" name="name"
                               id="username">
...
<!--Javascript-->
<script src="{{asset('admin/js/main.js')}}/js/main.js"></script>
